...
def time_ana(msg_file='msg.csv', figsize=(12, 8)):
    ...
    print(f"The first day: {date0.strftime('%Y-%m-%d')}\nThe last day: {date1.strftime('%Y-%m-%d')}\n"
          f"Total {n_date} days")
    # 月度数据
    ...
    plt.ylabel('消息条数')
    plt.savefig('figs/Monthly_changes_in_the_number_of_messages.png')
    ...
    plt.savefig('figs/Changes_in_the_number_of_messages_per_hour.png')
    print('=' * 20)
